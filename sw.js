const CACHE_NAME="27-1-study-v1";
const ASSETS=["./","./index.html","./manifest.webmanifest","./version.json","./icons/icon-192.png","./icons/icon-512.png","./icons/apple-touch-icon.png"];
